...
\begin{frame}
  \frametitle{Branching out -- checkout}
    ...
    \command{git checkout} - The sonic screwdriver of git \\[1em]
    Used to:
    \begin{itemize}
        \item Jump to branches
        \begin{itemize}
            \item[] \command{git checkout mybranch}
        \end{itemize}
        \item Create branches
        \begin{itemize}
            \item[] \command{git checkout -b newbranch}
        \end{itemize}
        \item Undo changes
        \begin{itemize}
            \item[] \command{git checkout -- file.txt}
        \end{itemize}
    \end{itemize}
...
\begin{frame}
  \frametitle{Branching out -- branch}
    ...
    \begin{itemize}
        ...
        \item Create branches
        \begin{itemize}
            \item[] \command{git branch newbranch}
        \end{itemize}
        \item Delete branches
        \begin{itemize}
            \item[] \command{git branch -d mergedbranch}
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Branching in -- merge} % #1
    ...
    \command{git merge featurebranch} \\[3em]
