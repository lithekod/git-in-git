...
\begin{frame}
  \frametitle{Branching out -- log (again!)}
    ...
    \alt<2->{\command{git checkout 479ad80ddf}}{\command{git checkout <hash>}}
...
\begin{frame}[fragile]
  ...
  \begin{tabular}{ll}
    \keyword{Basic} \vspace{-0.15em} & \\
    \command{git add} & I want to keep these! \vspace{-0.2em}\\
    \command{git commit} & I did a thing! \vspace{-0.2em}\\
    \command{git push} & I want to share this! \vspace{-0.2em}\\ % mention pull

    \keyword{Informative} & \vspace{-0.15em}\\
    \command{git status} & What is happening? \vspace{-0.2em}\\
    \command{git diff} & What has changed? \vspace{-0.2em}\\
    \command{git log} & What has happened? \vspace{-0.2em}\\
    \command{git show} & What changed over there? \vspace{-0.2em}\\

    \keyword{Create branch} & \vspace{-0.15em}\\
    \command{git checkout} & Jump to a branch! \vspace{-0.2em}\\
    \command{git branch} & Manage branches! \vspace{-0.2em}\\

    \keyword{Combine branch} & \vspace{-0.15em}\\
    \command{git merge} & I want both this and that! \vspace{-0.2em}\\
    \command{git pull} & I want \emph{your} stuff! \\
  \end{tabular}
\end{frame}
